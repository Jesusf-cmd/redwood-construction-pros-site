...
const PageCTA = ({
  heading = "Get a fast, no-pressure estimate for your project",
  subtext = "Limited scheduling available — we book projects on a first-come basis.",
}: PageCTAProps) => (
  <section className="section-pad bg-primary">
    <div className="max-w-[800px] mx-auto text-center">
      ...
      <p className="text-primary-foreground/60 font-medium mt-6">{subtext}</p>
      <Link
        to="/contact"
        className="inline-flex items-center gap-2 bg-accent text-accent-foreground font-bold text-base px-8 py-4 rounded-lg no-underline hover:bg-orange-hover transition-colors mt-6"
      >
